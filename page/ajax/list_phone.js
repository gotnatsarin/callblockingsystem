                        ...
                        try {
                            ...
                            new_data.forEach((element, index) => {
                                ...
                                if (parseInt(element['status']) == 0) {
                                    html += '<td><button class="btn btn-success active" value="' + element['id'] + '" id="Toggle">ระงับการใช้งาน</button></td>'
                                } else {
                                    html += '<td><button class="btn btn-success" value="' + element['id'] + '" id="Toggle">ใช้งานได้</button></td>'
                                }
